<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/HRMasterPage.master"
    AutoEventWireup="false" CodeFile="Resigned.aspx.vb" Inherits="recHRMDinfo_Profile_Resigned"
    Title="Untitled Page" %>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 756px">
                    <asp:Panel ID="paneDisplay" runat="server" Height="401px" Width="752px">
        ...
        <tr>
            ...
            <td style="width: 584px">
                ...
                <asp:Label ID="lblheader2" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Arial"
                    Font-Size="13px" ForeColor="Black" Text="&gt; Resigned" Font-Underline="True">
                </asp:Label>
            </td>
