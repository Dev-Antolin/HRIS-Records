<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/HRMasterPage.master"
    AutoEventWireup="false" CodeFile="APEUpload.aspx.vb" Inherits="recHRMDinfo_Documents_APEUpload"
    Title="Untitled Page" %>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td style="width: 237px">
                    <asp:TextBox runat="server" Font-Names="Arial" Font-Size="12px" Height="16px" Width="218px"
                        ID="txtdate" ReadOnly="True"></asp:TextBox>
                    <asp:CalendarExtender ID="calexdate" runat="server" TargetControlID="txtdate" Enabled="true">
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    &nbsp;<asp:FileUpload ID="fUpApe" runat="server" Font-Names="Arial" Font-Size="12px"
