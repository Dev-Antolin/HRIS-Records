<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/DisciplineMasterPage.master"
    AutoEventWireup="false" CodeFile="disCaseApplication.aspx.vb" Inherits="DisDiscipline_disCaseApplication"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div style="width: 195px; height: 334px;">
        ...
        <br />
        <ul style="list-style: none;">
            <li style="margin-left: 20px; cursor: pointer;" class="effects2"><a style="color: red;
                font-size: small;">
    ...
    <table style="width: 100%;">
        <tr>
            <td style="width: 107px">
                <asp:Label ID="txtapplication" runat="server" Font-Names="Arial" Font-Size="Small"
                    Text="Application No." ForeColor="Black"></asp:Label>
            </td>
            ...
            <td style="width: 80px">
                <asp:Label ID="lbldate" runat="server" Font-Names="Arial" Font-Size="Small" Text="Report Date"
        ...
        <tr>
            <td style="width: 107px">
                <asp:Label ID="txttype" runat="server" Font-Names="Arial" Font-Size="Small" Text="Disciplinary Type"
                    ForeColor="Black"></asp:Label>
            </td>
            <td style="width: 144px">
            ...
            <td style="width: 80px">
                <asp:Label ID="lblresource" runat="server" Font-Names="Arial" Font-Size="Small" Text="Resource"
                    ForeColor="Black"></asp:Label>
            </td>
            <td style="width: 187px">
            ...
            <td>
                <asp:ImageButton runat="server" ID="imgsearchemployee" ImageUrl="~/images/t.png"
                    Height="22px" />
            </td>
        </tr>
        <tr>
            <td style="width: 107px">
                <asp:Label ID="txtvalue" runat="server" Font-Names="Arial" Font-Size="Small" Text="Value"
                    ForeColor="Black"></asp:Label>
            </td>
            <td style="width: 144px">
            ...
            <td style="width: 80px">
                <asp:Label ID="lblmanager" runat="server" Font-Names="Arial" Font-Size="Small" Text="Manager"
                    ForeColor="Black"></asp:Label>
            </td>
            <td style="width: 187px">
        ...
        <tr>
            ...
            <td style="width: 80px">
                <asp:Label ID="lblbc" runat="server" Font-Names="Arial" Font-Size="Small" Text="BC"
                    ForeColor="Black"></asp:Label>
            </td>
            <td style="width: 187px">
        ...
        <tr>
            <td style="width: 107px" align="right">
                <asp:Label ID="lbldescription" runat="server" Font-Names="Arial" Font-Size="Small"
                    Text="Description" ForeColor="Black"></asp:Label>
            </td>
            <td style="width: 144px">
                &nbsp;
            </td>
            ...
            <td style="width: 80px">
                <asp:Label ID="lblattachment" runat="server" Font-Names="Arial" Font-Size="Small"
                    Text="Attachment" ForeColor="Black"></asp:Label>
            </td>
            <td style="width: 187px">
                <asp:TextBox ID="TextBox7" runat="server" Width="205px" BackColor="Gainsboro" ReadOnly="true"></asp:TextBox>
            </td>
            <td>
                <asp:ImageButton runat="server" ID="cmdbrowse" ImageUrl="~/images/Buttons/browse.gif"
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td style="width: 353px; height: 61px;" align="right">
                <asp:TextBox ID="TextBox8" runat="server" Width="352px" Height="85px" TextMode="MultiLine"
        ...
        <tr>
            ...
            <td style="width: 353px">
                <asp:Label ID="lblcomments" runat="server" Font-Names="Arial" Font-Size="Small" Text="Comment/s"
                    ForeColor="Black"></asp:Label>
            </td>
            <td style="width: 87px">
            </td>
        ...
        <tr>
            ...
            <td style="width: 353px" align="right">
                <asp:TextBox ID="TextBox9" runat="server" Width="351px" Height="86px" TextMode="MultiLine"
                    Font-Names="Arial" Font-Size="Small"></asp:TextBox>
            </td>
            <td style="width: 87px">
            </td>
        ...
        <tr>
            ...
            <td style="height: 117px; width: 87px;">
            </td>
            <td style="height: 117px">
            </td>
        </tr>
