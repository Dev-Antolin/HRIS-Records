<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/LegalMasterPage.master" AutoEventWireup="false" CodeFile="disReceiveCase.aspx.vb" Inherits="DisDiscipline_disCaseApplication" title="Untitled Page" %>
...
<a style="color:Red;"><asp:Label ID="lblreceive" runat="server" Text="> Receive Case" Height="16px" Width="177px"></asp:Label></a><br />
...
<ul><li class="labeltopformflow"><asp:Label ID="dislegal" runat="server" Text="HRMD > Discipline > Workforce Administration "></asp:Label>
        <asp:Label ID="labelposition" Font-Underline="true" ForeColor="Black" runat="server" Text="> Receive Case"></asp:Label>
        </li></ul> 
        </td>
        <td align="right">
