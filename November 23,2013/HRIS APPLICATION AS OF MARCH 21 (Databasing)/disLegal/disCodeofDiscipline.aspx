<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/LegalMasterPage.master" AutoEventWireup="false" CodeFile="disCodeofDiscipline.aspx.vb" Inherits="DisDiscipline_disCaseApplication" title="Untitled Page" %>
...
<li style="margin-left:15px; cursor:pointer;" class="effects2">
...
<a  style="color:red; font-size:small;"><asp:Label ID="lblcodes" runat="server" Text="> Code of Discipline" Height="16px" Width="177px"></asp:Label></a><br />
    ...
    <table style="width:100%;">
        <tr>
            <td style="width: 111px">
                <asp:Label ID="lblcode" runat="server" Font-Names="Arial" Font-Size="Small" 
                    ForeColor="Black" Text="Code"></asp:Label>
            </td>
        ...
        <td style="width: 182px">
                &nbsp;</td>
            <td>
                <asp:Label ID="lblincidents" runat="server" Font-Names="Arial" 
                    Font-Size="Small" ForeColor="Black" Text="Incidents"></asp:Label>
            </td>
        </tr>
    </table>
    <table style="width:100%;">
<tr>
            ...
            <td style="width: 28px" rowspan="5">
                <asp:TextBox ID="TextBox3" runat="server" BackColor="#DEDCDD" Width="359px" 
                    Font-Names="Arial" ForeColor="Black" Height="85px" TextMode="MultiLine"></asp:TextBox>
            </td>
        <td style="width: 30px">
                &nbsp;</td>
            <td rowspan="5">
                <asp:TextBox ID="TextBox4" runat="server" BackColor="#DEDCDD" Width="256px" 
                    Font-Names="Arial" ForeColor="Black" Height="85px" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td style="width: 28px">
                ...
                <asp:Label ID="lblnote" runat="server" Font-Names="Arial Unicode MS" Font-Size="11px" 
                    ForeColor="Red" Text="NOTE:"></asp:Label>
                        ...
                        <td>
                            <asp:Label ID="lblmessage" runat="server" Font-Names="Arial Unicode MS" 
                                ForeColor="Black" 
        ...
        <td style="width: 30px">
          ...
          <tr>
            <td style="width: 111px; height: 18px;">
                <asp:Label ID="lblpenalty" runat="server" Font-Names="Arial" Font-Size="Small" 
                    ForeColor="Black" Text="Penalty"></asp:Label>
              </td>
            <td style="width: 28px" rowspan="5">
            <asp:Panel ID="pnlpenalty" runat="server" BackColor="Gray" BorderColor="#993300" 
                ...
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                    ...
                    CellPadding="3" GridLines="None" Height="26px" Width="359px">
...
<ul><li class="labeltopformflow"><asp:Label ID="dislegal" runat="server" Text="HRMD > Discipline > Workforce Administration "></asp:Label>
        <asp:Label ID="labelposition" Font-Underline="true" ForeColor="Black" runat="server" Text="> Code of Discipline"></asp:Label>
        </li></ul> 
        </td>
        <td align="right">
