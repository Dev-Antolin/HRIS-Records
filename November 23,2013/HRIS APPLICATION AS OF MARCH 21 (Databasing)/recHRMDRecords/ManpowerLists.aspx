<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/HRMasterPage.master"
    AutoEventWireup="false" CodeFile="ManpowerLists.aspx.vb" Inherits="recHRMDinfo_Profile_ManpowerLists"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 57px">
                    &nbsp;<asp:Label ID="Label162" runat="server" Font-Names="Arial" Font-Size="12px"
                        ForeColor="Black" Text="Category"></asp:Label>
                </td>
                <td style="width: 130px">
                    <asp:DropDownList runat="server" Font-Names="Arial" Height="20px" Width="119px" ID="cboCategory">
                ...
                <td style="width: 130px">
                    <asp:DropDownList runat="server" Font-Names="Arial" Height="20px" Width="119px" ID="cboSort">
                        <asp:ListItem></asp:ListItem>
                ...
                <td style="width: 130px">
                    <asp:DropDownList runat="server" Font-Names="Arial" Height="20px" Width="119px" ID="cboMonth">
                        <asp:ListItem></asp:ListItem>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 756px">
                    <asp:Panel ID="panelDisplay" runat="server" Height="376px" Width="752px">
                        <CR:CrystalReportViewer ID="rptViewer" runat="server" 
    AutoDataBind="True" BackColor="White" BestFitPage="False" BorderColor="Black" 
    BorderStyle="Solid" BorderWidth="1px" DisplayGroupTree="False" EnableDrillDown="False" EnableParameterPrompt="False" 
    ...
    Height="375px" ReportSourceID="rptSource" SkinID="0" toolbarstyle-width="748" 
    Width="750px" Visible="False" />
                            
                        <CR:CrystalReportSource ID="rptSource" runat="server">
                            <Report FileName="Reports\rptManPowerList.rpt">
                            </Report>
        ...
        <tr>
            ...
            <td style="width: 575px">
                ...
                <asp:Label ID="lblheader2" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Arial"
                    Font-Size="13px" ForeColor="Black" Text="&gt; Manpower Lists" Font-Underline="True">
                </asp:Label>
            </td>
