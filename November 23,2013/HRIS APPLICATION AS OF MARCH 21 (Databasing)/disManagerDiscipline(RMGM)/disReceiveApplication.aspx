<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/ManagerMaster.master" AutoEventWireup="false" CodeFile="disReceiveApplication.aspx.vb" Inherits="DisDiscipline_disCaseApplication" title="Untitled Page" %>
...
<ul><li class="labeltopformflow"><asp:Label ID="managerdis" runat="server" Text="Manager > Discipline > Workforce Administration "></asp:Label>
        <asp:Label ID="labelposition" Font-Underline="true" ForeColor="Black" runat="server" Text="> Receive Application"></asp:Label>
        </li></ul> 
        </td>
        <td align="right">
