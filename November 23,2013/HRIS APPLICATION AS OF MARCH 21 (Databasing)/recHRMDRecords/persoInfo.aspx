<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/HRMasterPage.master"
    AutoEventWireup="false" CodeFile="persoInfo.aspx.vb" Inherits="recHRMDinfo_persoInfo"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 782px; height: 444px;">
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 115px">
                    <asp:TextBox ID="textbox1" runat="server" Font-Names="Arial" Height="16px" Width="107px"
                ...
                <td style="width: 115px">
                    <asp:TextBox ID="textbox2" runat="server" Font-Names="Arial" Height="16px" 
                        Width="107px" CssClass="blacktext" ForeColor="Blue"></asp:TextBox>
                </td>
                <td style="width: 129px">
                    <asp:ImageButton ID="cmdBrowse2" runat="server" Height="16px" ImageUrl="~/images/searchlens.jpg"
                        Width="20px" />
                </td>
                <td style="width: 72px">
        ...
        <asp:TabContainer ID="tcRecords" runat="server" ActiveTabIndex="0" Height="410px"
            Width="776px" Font-Size="X-Small" Font-Names="Arial" ForeColor="Black" 
            EnableTheming="True" BorderStyle="None">
...
<ContentTemplate><br /><asp:Label ID="Label29" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="#3333FF"
            ...
            <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="Employment">
                <HeaderTemplate>Employment</HeaderTemplate>
...
<ContentTemplate><br /><table style="width: 100%;"><tr><td style="width: 31px">&#160;&#160; </td><td style="width: 107px"><asp:Label ID="Label50" runat="server" Text="Position" Font-Size="Small" Font-Names="Arial"></asp:Label></td><td style="width: 334px"><asp:TextBox ID="textbox21" runat="server" Height="16px" Width="285px" 
            ...
            <asp:TabPanel ID="TabPanel3" runat="server" HeaderText="Family Background">
                <HeaderTemplate>Family Background</HeaderTemplate>
...
<ContentTemplate><br /><table style="width: 100%;"><tr><td style="width: 92px"><asp:Label ID="Label67" runat="server" Text="Spouse's Name" Font-Names="Arial" Font-Size="12px"></asp:Label></td><td 
        style="width: 292px"><asp:TextBox ID="textbox28" runat="server" 
        Enabled="False" Font-Names="Arial" Font-Size="12px" Height="14px" Width="86px"></asp:TextBox><asp:TextBoxWatermarkExtender 
        ID="tbwes1" runat="server" Enabled="True" TargetControlID="textbox28" 
        WatermarkCssClass="waterTxt" WatermarkText="Surname"></asp:TextBoxWatermarkExtender><asp:TextBox 
        ID="textbox29" runat="server" Enabled="False" Font-Names="Arial" 
        Font-Size="12px" Height="14px" Width="86px"></asp:TextBox><asp:TextBoxWatermarkExtender 
        ID="tbwes2" runat="server" Enabled="True" TargetControlID="textbox29" 
        WatermarkCssClass="waterTxt" WatermarkText="Given Name"></asp:TextBoxWatermarkExtender><asp:TextBox 
        ID="textbox30" runat="server" Enabled="False" Font-Names="Arial" 
        Font-Size="12px" Height="14px" Width="86px"></asp:TextBox><asp:TextBoxWatermarkExtender 
        ID="tbwe3" runat="server" Enabled="True" TargetControlID="textbox30" 
        WatermarkCssClass="waterTxt" WatermarkText="Middle Name"></asp:TextBoxWatermarkExtender></td><td><asp:Label 
            ...
            Font-Names="Arial" Font-Size="12px" Text="Occupation"></asp:Label></td><td style="width: 292px"><asp:TextBox ID="textbox31" runat="server" Height="14px" Width="276px" Font-Size="12px"
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td 
            rowspan="3"><asp:Panel ID="Panel1" runat="server" BackColor="#666666" 
                BorderColor="Black" BorderStyle="Solid" BorderWidth="2px" Height="55px" 
                ScrollBars="Auto" Width="363px"><asp:GridView ID="dgridChildren" runat="server" 
                    AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" 
                    BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" 
                    GridLines="Vertical" Height="55px" OnRowCommand="dgridChildren_RowCommand" 
                    Width="363px"><AlternatingRowStyle BackColor="#CCCCCC"></AlternatingRowStyle>
                    <Columns>
                        <asp:TemplateField HeaderText="Names"><ItemTemplate><asp:TextBox ID="txtchild1" 
                                runat="server" Font-Names="Arial" Font-Size="10px" Width="290px"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Ages"><ItemTemplate><asp:TextBox ID="txtchild2" 
                                runat="server" Font-Names="Arial" Font-Size="10px" Width="60px"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:TemplateField>
                    </Columns>
                ...
                </asp:GridView></asp:Panel></td></tr><tr><td style="width: 92px"><asp:Label ID="Label69" runat="server" Text="Employed By" Font-Size="12px" Font-Names="Arial"></asp:Label></td><td style="width: 292px"><asp:TextBox ID="textbox32" runat="server" Height="14px" Width="276px" Font-Size="12px"
            ...
            Font-Names="Arial" Font-Size="12px" Text="Father's Name"></asp:Label></td><td 
                            ...
                            style="width: 89px"><asp:Label ID="Label73" runat="server" Font-Names="Arial" 
                                Font-Size="12px" Text="Mother's Name"></asp:Label></td><td><asp:TextBox 
                ID="textbox40" runat="server" Enabled="False" Font-Names="Arial" 
                Font-Size="12px" Height="14px" Width="86px"></asp:TextBox><asp:TextBoxWatermarkExtender 
                ID="TextBoxWatermarkExtender4" runat="server" Enabled="True" 
                TargetControlID="textbox40" WatermarkCssClass="waterTxt" 
                WatermarkText="Surname"></asp:TextBoxWatermarkExtender><asp:TextBox 
                ID="textbox41" runat="server" Enabled="False" Font-Names="Arial" 
                Font-Size="12px" Height="14px" Width="86px"></asp:TextBox><asp:TextBoxWatermarkExtender 
                ID="TextBoxWatermarkExtender5" runat="server" Enabled="True" 
                TargetControlID="textbox41" WatermarkCssClass="waterTxt" 
                WatermarkText="Given Name"></asp:TextBoxWatermarkExtender><asp:TextBox 
                ID="textbox42" runat="server" Enabled="False" Font-Names="Arial" 
                Font-Size="12px" Height="14px" Width="86px"></asp:TextBox><asp:TextBoxWatermarkExtender 
                ID="TextBoxWatermarkExtender6" runat="server" Enabled="True" 
                TargetControlID="textbox42" WatermarkCssClass="waterTxt" 
                ...
                Font-Names="Arial" Font-Size="12px" Text="Occupation"></asp:Label></td><td 
                    ...
                    ID="textbox43" runat="server" Font-Names="Arial" Font-Size="12px" Height="14px" 
                    ReadOnly="True" Width="276px"></asp:TextBox></td></tr><tr><td 
                ...
                Font-Names="Arial" Font-Size="12px" Text="Employed By"></asp:Label></td><td 
                    ...
                    ID="textbox44" runat="server" Font-Names="Arial" Font-Size="12px" Height="14px" 
                    ReadOnly="True" Width="276px"></asp:TextBox></td></tr><tr><td 
                ...
                Font-Names="Arial" Font-Size="12px" Text="Contact No."></asp:Label></td><td 
                    ...
                    ID="textbox45" runat="server" Font-Names="Arial" Font-Size="12px" Height="14px" 
                    ReadOnly="True" Width="276px"></asp:TextBox></td></tr></table><br /><table style="width: 100%;"><tr><td 
            ...
            Text="Names of Siblings (from ELDEST to YOUNGEST)"></asp:Label></td><td><asp:Panel 
                ...
                BorderStyle="Solid" BorderWidth="2px" Height="111px" ScrollBars="Auto" 
                Width="656px"><asp:GridView ID="dgridChildren0" runat="server" 
                AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" 
                BorderStyle="Solid" BorderWidth="1px" CellPadding="3" 
                EmptyDataText="No Records Found!" ForeColor="Black" GridLines="Vertical" 
                Height="58px" Width="610px"><AlternatingRowStyle BackColor="#CCCCCC">
                </AlternatingRowStyle>
                <Columns>
                    <asp:TemplateField HeaderText="Names"><ItemTemplate><asp:TextBox ID="txtsiblings1" 
                            runat="server" Font-Names="Arial" Font-Size="11px"></asp:TextBox>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Ages"><ItemTemplate><asp:TextBox ID="txtsiblings2" 
                            runat="server" Font-Names="Arial" Font-Size="11px" Width="30px"></asp:TextBox>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Status"><ItemTemplate><asp:TextBox ID="txtsiblings3" 
                            runat="server" Font-Names="Arial" Font-Size="11px" Width="45px"></asp:TextBox>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Occupation"><ItemTemplate><asp:TextBox 
                            ID="txtsiblings4" runat="server" Font-Names="Arial" Font-Size="11px"></asp:TextBox>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Company"><ItemTemplate><asp:TextBox 
                            ID="txtsiblings5" runat="server" Font-Names="Arial" Font-Size="11px"></asp:TextBox>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Spouse Name"><ItemTemplate><asp:TextBox 
                            ID="txtsiblings6" runat="server" Font-Names="Arial" Font-Size="11px" 
                            Width="90px"></asp:TextBox>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Occupation"><ItemTemplate><asp:TextBox 
                            ID="txtsiblings7" runat="server" Font-Names="Arial" Font-Size="11px" 
                            Width="90px"></asp:TextBox>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Company"><ItemTemplate><asp:TextBox 
                            ID="txtsiblings8" runat="server" Font-Names="Arial" Font-Size="11px"></asp:TextBox>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                </Columns>
                <EmptyDataRowStyle BackColor="LightBlue" Font-Size="30px" 
                    HorizontalAlign="Center" VerticalAlign="Middle"></EmptyDataRowStyle>
                <FooterStyle BackColor="#CCCCCC"></FooterStyle>
                <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" Height="14px">
                </HeaderStyle>
                <PagerStyle BackColor="#999999" ForeColor="Black" HorizontalAlign="Center">
            ...
            </asp:GridView></asp:Panel></td></tr></table><br /><table style="width: 100%; height: 28px;"><tr><td 
            ...
            <asp:TabPanel ID="TabPanel4" runat="server" HeaderText="Technical Background">
                <HeaderTemplate>Technical Background</HeaderTemplate>
...
<ContentTemplate><asp:Label ID="Label83" runat="server" Font-Bold="True" Font-Size="11px" ForeColor="#3333FF"
            ...
            <asp:TabPanel ID="TabPanel5" runat="server" HeaderText="Work Experience">
                <HeaderTemplate>Work Experience</HeaderTemplate>
 ...
 <ContentTemplate><asp:Label ID="Label112" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#3333FF"
                        ...
                        Text="Other Information" Font-Names="Arial"></asp:Label><br /><table style="width: 100%;"><tr><td><asp:Label ID="Label126" runat="server" Text="Special Skills" Font-Size="12px" Font-Names="Arial"></asp:Label>&nbsp;&nbsp;<asp:CheckBox
                                ...
                                runat="server" Font-Size="12px" Height="14px" Width="272px"
                                    ...
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td></tr></table><table style="width: 100%;"><tr><td style="width: 61px"><asp:Label ID="Label129" runat="server" Font-Size="12px" Text="Name" Font-Names="Arial"></asp:Label></td><td style="width: 202px"><asp:TextBox ID="txtfriendN1" runat="server" Font-Size="12px" Height="14px" Width="198px"
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td style="width: 48px"><asp:Label ID="Label130" runat="server" Font-Size="12px" Text="Position" Font-Names="Arial"></asp:Label></td><td style="width: 202px"><asp:TextBox ID="txtfriendP1" runat="server" Font-Size="12px" Height="14px" Width="198px"
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td style="width: 48px"><asp:Label ID="Label131" runat="server" Font-Size="12px" Text="Relation" Font-Names="Arial"></asp:Label></td><td><asp:TextBox ID="txtfriendR1" runat="server" Font-Size="12px" Height="14px" Width="198px"
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td></tr><tr><td style="width: 61px"><asp:Label ID="Label132" runat="server" Font-Size="12px" Text="Name" Font-Names="Arial"></asp:Label></td><td style="width: 202px"><asp:TextBox ID="txtfriendN2" runat="server" Font-Size="12px" Height="14px" Width="198px"
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td style="width: 48px"><asp:Label ID="Label134" runat="server" Font-Size="12px" Text="Position" Font-Names="Arial"></asp:Label></td><td style="width: 202px"><asp:TextBox ID="txtfriendP2" runat="server" Font-Size="12px" Height="14px" Width="198px"
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td style="width: 48px"><asp:Label ID="Label136" runat="server" Font-Size="12px" Text="Relation" Font-Names="Arial"></asp:Label></td><td><asp:TextBox ID="txtfriendR2" runat="server" Font-Size="12px" Height="14px" Width="198px"
...
<ContentTemplate><asp:Label ID="Label143" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#3333FF"
                        ...
                        Text="Reference (Give atleast one from your community)" Font-Names="Arial"></asp:Label><br /><table style="width: 100%;"><tr style="text-align: center"><td style="width: 186px;"><asp:Label ID="Label149" runat="server" Font-Size="12px" Text="Name" Font-Names="Arial"></asp:Label></td><td style="width: 186px;"><asp:Label ID="Label150" runat="server" Font-Size="12px" Text="Address" Font-Names="Arial"></asp:Label></td><td style="width: 186px;"><asp:Label ID="Label151" runat="server" Font-Size="12px" Text="Contact No." Font-Names="Arial"></asp:Label></td><td><asp:Label ID="Label152" runat="server" Font-Size="12px" Text="Occupation" Font-Names="Arial"></asp:Label></td></tr><tr><td style="width: 186px;"><asp:TextBox ID="txtcref1" runat="server" Height="16px" Width="181px" 
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td style="width: 186px;"><asp:TextBox ID="txtcref2" runat="server" Height="16px" Width="181px" 
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td style="width: 186px;"><asp:TextBox ID="txtcref3" runat="server" Height="16px" Width="181px" 
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td><asp:TextBox ID="txtcref4" runat="server" Height="16px" Width="181px" 
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td></tr><tr><td style="width: 186px;"><asp:TextBox ID="txtcref5" runat="server" Height="16px" Width="181px" 
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td style="width: 186px;"><asp:TextBox ID="txtcref6" runat="server" Height="16px" Width="181px" 
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td style="width: 186px;"><asp:TextBox ID="txtcref7" runat="server" Height="16px" Width="181px" 
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td><asp:TextBox ID="txtcref8" runat="server" Height="16px" Width="181px" 
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td></tr><tr><td style="width: 186px;"><asp:TextBox ID="txtcref9" runat="server" Height="16px" Width="181px" 
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td style="width: 186px;"><asp:TextBox ID="txtcref10" runat="server" Height="16px" Width="181px" 
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td style="width: 186px;"><asp:TextBox ID="txtcref11" runat="server" Height="16px" Width="181px" 
                                    Font-Names="Arial" ReadOnly="True"></asp:TextBox></td><td><asp:TextBox ID="txtcref12" runat="server" Height="16px" Width="181px" 
            ...
            <asp:TabPanel ID="TabPanel7" runat="server" HeaderText="Notification">
                <HeaderTemplate>Notification</HeaderTemplate>
...
<ContentTemplate><asp:Label ID="Label168" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="12px"
            ...
            <asp:TabPanel ID="TabPanel8" runat="server" HeaderText="Rights">
                <HeaderTemplate>Rights</HeaderTemplate>
                
<ContentTemplate><br /><table style="width: 100%;"><tr><td style="width: 212px">&#160;&#160; </td><td style="width: 15px">&#160;&#160; </td><td rowspan="5" style="width: 478px"><table style="background-color: #CCCCCC; border: thin groove #000000; width: 101%;
                                    height: 82px" border="1px" frame="hsides"><tr style="background-color: Gray; text-align: center"><td style="width: 441px"><asp:Label ID="Label159" runat="server" Font-Bold="True" Font-Size="12px" Text="Portals"
                                                Font-Names="Arial"></asp:Label></td><td style="width: 262px"><asp:Label ID="Label160" runat="server" Font-Bold="True" Font-Size="12px" Text="Modules"
                                                Font-Names="Arial"></asp:Label></td></tr><tr><td style="width: 441px"><asp:CheckBox ID="chkEmployee" runat="server" AutoPostBack="True" Font-Size="Small"
                                                Text=" Employee" Font-Names="Arial" /></td><td style="width: 262px"><asp:CheckBox ID="chkrecords" runat="server" Font-Size="12px" 
                Font-Names="Arial" Height="16px" Width="19px" /><asp:linkbutton ID="linkrec" runat="server" Font-Names="Arial" Font-Size="12px" 
                Text="Records" Font-Overline=False ForeColor=Black></asp:linkbutton></td></tr><tr><td style="width: 441px"><asp:CheckBox ID="chkManager" runat="server" Font-Size="Small" Text=" Manager" Font-Names="Arial"
                                                AutoPostBack="True" /></td><td style="width: 262px"><asp:CheckBox ID="chkPayroll" runat="server" Font-Names="Arial" Height="16px" 
                Width="20px" />&nbsp;<asp:linkbutton ID="linkpayroll" runat="server" Font-Names="Arial" Font-Size="12px" 
                Text="Payroll" Font-Overline=False ForeColor=Black></asp:linkbutton></td></tr><tr><td style="width: 441px"><asp:CheckBox ID="chkHRMD" runat="server" Font-Size="Small" Text=" HRMD" Font-Names="Arial"
                                                AutoPostBack="True" /></td><td style="width: 262px"><asp:CheckBox ID="chkdiscipline" runat="server" Font-Size="12px"
                                                Font-Names="Arial" Height="16px" 
                Width="20px" />&nbsp;<asp:linkbutton ID="linkdiscipline" runat="server" Font-Names="Arial" Font-Size="12px" 
                Text="Discipline" Font-Overline=False ForeColor=Black></asp:linkbutton></td></tr><tr><td style="width: 441px"><asp:CheckBox ID="chkLegal" runat="server" Font-Size="Small" Text=" Legal" Font-Names="Arial"
                                                AutoPostBack="True" /></td><td style="width: 262px"><asp:CheckBox ID="chkErecruitment" runat="server" Font-Size="12px"
                                                Font-Names="Arial" Height="18px" 
                Width="20px" />&nbsp;<asp:linkbutton ID="linkerec" runat="server" Font-Names="Arial" Font-Size="12px" 
                Text="E-Recruitment" Font-Overline=False ForeColor=Black></asp:linkbutton></td></tr><tr><td style="width: 441px">&#160;&#160; </td><td style="width: 262px"><asp:CheckBox ID="chkadministration" runat="server" Font-Size="12px"
                                                Font-Names="Arial" Height="18px" 
            Width="20px" />&nbsp;<asp:linkbutton ID="linkadmin" runat="server" Font-Names="Arial" Font-Size="12px" 
                Text="Administration" Font-Overline=False ForeColor=Black></asp:linkbutton></td></tr></table></td></tr><tr><td style="width: 212px"><asp:Label ID="Label157" runat="server" Font-Size="12px" Text="User Name:" Font-Names="Arial"></asp:Label></td><td style="width: 15px">&#160;&#160; </td></tr><tr><td style="width: 212px"><asp:TextBox ID="txtusername" runat="server" Height="16px" Width="198px" Font-Names="Arial"></asp:TextBox></td><td style="width: 15px">&#160;&#160; </td></tr><tr><td style="width: 212px"><asp:Label ID="Label158" runat="server" Font-Size="12px" Text="Password:" Font-Names="Arial"></asp:Label></td><td style="width: 15px">&#160;&#160; </td></tr><tr><td style="width: 212px"><asp:TextBox ID="txtPassword" runat="server" Font-Names="Arial" Height="16px" TextMode="Password"
                                    Width="198px"></asp:TextBox></td><td style="width: 15px">&#160;&#160; </td></tr></table><br /><asp:Panel ID="pnlforms" runat="server" Height="163px" Visible="False"><asp:GridView ID="dgvforms" runat="server" AutoGenerateColumns="False" 
            BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" 
            CellPadding="3" GridLines="Vertical" Height="16px" Width="757px"><AlternatingRowStyle BackColor="Gainsboro" /><Columns><asp:BoundField HeaderText="Forms" DataField="FormName"><HeaderStyle Height="15px" HorizontalAlign="Center" VerticalAlign="Middle" 
                        Width="200px" /><ItemStyle Height="15px" /></asp:BoundField><asp:CheckBoxField HeaderText="R/W"><HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="8px" /><ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" /></asp:CheckBoxField><asp:CheckBoxField HeaderText="R"><HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="10px" /><ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" /></asp:CheckBoxField><asp:CheckBoxField HeaderText="View"><HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="8px" /><ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" /></asp:CheckBoxField><asp:CheckBoxField HeaderText="Print"><HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="8px" /><ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" /></asp:CheckBoxField></Columns><FooterStyle BackColor="#CCCCCC" ForeColor="Black" /><HeaderStyle BackColor="#000084" Font-Bold="True" ForeColor="White" 
                HorizontalAlign="Center" VerticalAlign="Middle" /><PagerStyle BackColor="#999999" ForeColor="Black" HorizontalAlign="Center" /><RowStyle BackColor="#EEEEEE" ForeColor="Black" /><SelectedRowStyle BackColor="#008A8C" Font-Bold="True" ForeColor="White" /></asp:GridView></asp:Panel><table style="width:100%;"><tr><td>&#160;</td></tr></table>
        ...
        <tr>
            ...
            <td style="width: 582px">
                <asp:Label ID="lblheader" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Arial"
                    Font-Size="13px" ForeColor="DodgerBlue" Text="HRMD &gt; Records &gt; Profile &gt; Employee Data ">
                </asp:Label>
