<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/DisciplineMasterPage.master"
    AutoEventWireup="false" CodeFile="disDisciplineScorecardReport.aspx.vb" Inherits="DisDiscipline_disCaseApplication"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel runat="server" ID="pnldisscore" Width="99%" Height="473px" ScrollBars="Vertical">
        <table style="width: 100%;">
            <tr>
                ...
                <td align="left">
                    <asp:ImageButton ID="cmdSearch" runat="server" Height="25px" ImageUrl="~/images/Buttons/Preview.gif"
                        Width="75px" />
                </td>
            </tr>
        </table>
        ...
        <table id="report" width="90%">
            <tr>
                ...
                <td style="width: 23px">
                    <asp:Panel ID="pnlreport" runat="server" Height="521px" Visible="False" Width="592px">
                        <asp:Image ID="Image15" runat="server" Height="519px" ImageUrl="~/images/disscore .jpg"
                            Width="589px" />
                        <br />
                        <br />
                    </asp:Panel>
