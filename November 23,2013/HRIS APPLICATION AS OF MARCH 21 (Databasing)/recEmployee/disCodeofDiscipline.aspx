<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/EmployeeDiscipline.master"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div style="width: 195px; height: 334px;">
        ...
        <br />
        <ul style="list-style: none;">
            <li style="margin-left: 15px; cursor: pointer;" class="effects2"><a>
                <asp:Label ID="lblcodes" runat="server" Text="> Code of Discipline" Height="16px"
            ...
            <td style="width: 553px">
                <ul>
                    <li class="labeltopformflow">
                        <asp:Label ID="employeedocuments" runat="server" Text="Employee > Discipline > Workforce Administration "></asp:Label>
                        <asp:Label ID="labelposition" Font-Underline="true" ForeColor="Black" runat="server"
                            Text="> Code of Discipline"></asp:Label>
                    </li>
                </ul>
            </td>
            <td align="right">
