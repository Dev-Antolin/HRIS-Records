<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/HRAdminSetup.master"
    AutoEventWireup="false" CodeFile="AdminJobRoles.aspx.vb" Inherits="recHRMDAdminModule_AdminDivisionRegion"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="width: 100%; height: 481px;">
        ...
        <table width="100%">
            <tr>
                ...
                <td style="width: 119px">
                    <asp:DropDownList ID="DropDownList1" runat="server" Width="108px" Height="21px" AutoPostBack="True">
                ...
                <td style="width: 430px">
                    <asp:DropDownList ID="DropDownList2" runat="server" Height="21px" Width="206px">
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" align="center">
            <tr>
                <td>
                    <asp:Panel ID="addpanel" runat="server" Height="237px" Width="275px" BackColor="Gainsboro"
                        ...
                        <table style="width: 97%;">
                            <tr>
                                ...
                                <td style="width: 149px">
                                    <asp:DropDownList ID="level" runat="server" Width="177px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 149px">
                                    <asp:DropDownList ID="category" runat="server" Width="177px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label2" runat="server" Font-Names="Arial" Font-Size="Small" Text="Job Title"></asp:Label>
                                </td>
                                <td style="width: 149px">
                                    <asp:DropDownList runat="server" ID="jobtitle" Width="177px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label3" runat="server" Font-Names="Arial" Font-Size="Small" Text="Job Role"></asp:Label>
                                </td>
                                <td style="width: 149px">
                                    <asp:TextBox ID="txtjobtitle" runat="server" Width="177px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 15px">
                                ...
                                <td>
                                    <asp:Label ID="Label4" runat="server" Font-Names="Arial" Font-Size="Small" Text="Description"></asp:Label>
                                </td>
                                <td style="width: 149px">
                                    <asp:TextBox ID="TextBox1" runat="server" Width="177px" Height="53px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        <br />
