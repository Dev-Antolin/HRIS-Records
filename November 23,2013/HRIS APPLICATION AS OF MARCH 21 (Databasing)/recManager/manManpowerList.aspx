<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/ManagerMasterPage.master"
    AutoEventWireup="false" CodeFile="manManpowerList.aspx.vb" Inherits="recMANAGERinfo_Profile_manManpowerList"
    Title="Untitled Page" %>
    ...
    <div>
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    <asp:Panel ID="panelDisplay" runat="server" Height="407px" Width="753px">
                        <asp:Image ID="imSgmanpower" runat="server" Height="407px" Width="753px" />
                    </asp:Panel>
                </td>
                <td>
                </td>
