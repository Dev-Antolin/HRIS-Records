<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/HRAdminSetup.master"
    AutoEventWireup="false" CodeFile="AdminJobCategory.aspx.vb" Inherits="recHRMDAdminModule_AdminDivisionRegion"
    Title="Untitled Page" %>
                ...
                <td>
                    <asp:Panel ID="Panel1" runat="server" BackColor="#333333" Height="222px">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="736px"
                            ...
                            <Columns>
                                <asp:BoundField HeaderText="Category" HeaderStyle-Width="250px" HeaderStyle-Height="30px"
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 350px">
                    <asp:Panel ID="addpanel" runat="server" Height="154px" Width="319px" BackColor="Gainsboro"
                        ...
                        <table style="width: 98%;">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="level" runat="server" Width="207px" AutoPostBack="True" AppendDataBoundItems="True">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="category" runat="server" Width="207px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        <br />
                        <table style="width: 83%; height: 27px;" align="right">
                            <tr>
                                <td>
                                    &nbsp;
                                </td>
