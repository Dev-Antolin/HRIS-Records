<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/HRMasterPage.master"
    AutoEventWireup="false" CodeFile="ActiveEmployees.aspx.vb" Inherits="recHRMDinfo_Profile_ActiveEmployees"
            ...
            <tr>
                ...
                <td>
                    <asp:ImageButton ID="cmdPreview" runat="server" Height="25px" ImageUrl="~/images/Buttons/Preview.gif"
                        Width="75px" Style="margin-left: 5px" />
                </td>
            </tr>
            <tr>
                <td style="width: 15px">
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 756px">
                    <asp:Panel ID="panelDisplay" runat="server" Height="403px" Width="752px">
        ...
        <tr>
            ...
            <td style="width: 437px">
                ...
                <asp:Label ID="lblheader2" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Arial"
                    Font-Size="13px" Font-Underline="True" ForeColor="Black" Text="&gt; Active Employee"> </asp:Label>
            </td>
