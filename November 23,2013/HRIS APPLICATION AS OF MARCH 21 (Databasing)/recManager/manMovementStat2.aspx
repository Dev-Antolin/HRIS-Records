<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/ManagerMasterPage.master"
    AutoEventWireup="false" CodeFile="manMovementStat2.aspx.vb" Inherits="recMANAGERinfo_Documents_manDiscipline"
    Title="Untitled Page" %>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 177px; height: 22px">
                    <asp:TextBox ID="txtGM" runat="server" Font-Names="Arial" Height="16px" Width="180px"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td style="width: 276px; height: 22px">
                    <asp:TextBox ID="txtEmp" runat="server" Font-Names="Arial" Height="16px" Width="180px"></asp:TextBox>
                </td>
                <td style="width: 88px; height: 22px">
                    <asp:Label ID="Label192" runat="server" Font-Names="Arial" Font-Size="12px" ForeColor="Black"
                        Text="Vice President"></asp:Label>
                </td>
                <td style="width: 177px; height: 22px">
                    <asp:TextBox ID="txtVP" runat="server" Font-Names="Arial" Height="16px" Width="180px"></asp:TextBox>
                </td>
                <td style="height: 22px">
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 128px">
                    <asp:Label ID="Label190" runat="server" Font-Names="Arial" Font-Size="12px" ForeColor="Black"
                        Text="Receiving RM"></asp:Label>
                </td>
                <td style="width: 276px">
                    <asp:TextBox ID="txtRecRM" runat="server" Font-Names="Arial" Height="16px" Width="180px"></asp:TextBox>
                </td>
                <td style="width: 88px">
