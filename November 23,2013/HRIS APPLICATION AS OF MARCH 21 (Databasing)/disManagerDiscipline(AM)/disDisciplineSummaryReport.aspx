<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/ManagerMaster.master" AutoEventWireup="false" CodeFile="disDisciplineSummaryReport.aspx.vb" Inherits="DisDiscipline_disCaseApplication" title="Untitled Page" %>
...
<ul style="list-style:none;">
<li class="effects2">
<a  style="color:red; font-size:small;"><asp:Label ID="dissum" runat="server" Text="> Discipline Summary" Height="16px" Width="177px"></asp:Label></a><br />
    ...
    <td style="width: 641px">
        <asp:Panel ID="pnlreport" runat="server" Height="318px" Visible="False" 
            ...
            <asp:Image ID="Image15" runat="server" Height="313px" 
                ImageUrl="~/images/dissumreport.jpg" Width="722px" />
        </asp:Panel>
        </td>
    <td></td>
    </tr>
...
<ul><li class="labeltopformflow"><asp:Label ID="managerdis" runat="server" Text="Manager > Discipline > Reports "></asp:Label>
        <asp:Label ID="labelposition" Font-Underline="true" ForeColor="Black" runat="server" Text="> Discipline Summary"></asp:Label>
        </li></ul> 
        </td>
        <td align="right">
