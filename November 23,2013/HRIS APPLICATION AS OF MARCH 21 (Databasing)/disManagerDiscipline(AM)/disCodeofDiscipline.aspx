<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/ManagerMaster.master" AutoEventWireup="false" CodeFile="disCodeofDiscipline.aspx.vb" Inherits="DisDiscipline_disCaseApplication" title="Untitled Page" %>
...
<a  style="color:red; font-size:small;"><asp:label id="lblcodedis" runat="server" Text="> Code of Discipline" height="16px" width="177px"></asp:label></a><br />
