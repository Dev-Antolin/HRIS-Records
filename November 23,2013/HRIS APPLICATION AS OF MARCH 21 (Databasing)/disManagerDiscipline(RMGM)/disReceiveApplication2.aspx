<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/ManagerMaster.master" AutoEventWireup="false" CodeFile="disReceiveApplication2.aspx.vb" Inherits="DisDiscipline_disCaseApplication" title="Untitled Page" %>
...
<a  style="color:red; font-size:small;"><asp:label id="lblrecapp" runat="server" Text="> Receive Application" height="16px" width="177px"></asp:label></a><br />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel runat="server" ID="pnlrecapplication2" Width="100%" Height="479px">
    ...
    <tr>
    <td style="width: 41px; height: 61px;"></td>
    <td style="width: 353px; height: 61px;" align="right">
        <asp:TextBox ID="TextBox7" runat="server" Width="352px" Height="66px" 
            ...
            BackColor="#D4D0C8" ReadOnly="True"></asp:TextBox>
        </td>
    ...
    <tr>
    <td style="height: 117px; width: 41px;"></td>
     <td style="height: 117px">
         <table style="width:101%; height: 100px;">
             <tr>
              ...
              <tr>
                 ...
                 <td>
                     <asp:TextBox ID="TextBox11" runat="server" BackColor="#D4D0C8" 
                         Font-Names="Arial" Font-Size="Small" Height="48px" TextMode="MultiLine" 
                         Width="352px" ReadOnly="True"></asp:TextBox>
                 </td>
                 </tr>
                 <tr>
                 <td style="width: 12px"></td>
                 <td rowspan="5px">
                     <asp:TextBox ID="TextBox12" runat="server" Font-Names="Arial" Font-Size="Small" 
                         Height="47px" TextMode="MultiLine" Width="353px"></asp:TextBox>
                 </td>
                 </tr>
                </table>
                  </td>
      ...
      <td style="height: 117px; " align="center" colspan="2">
          <asp:Panel ID="Panel1" runat="server" BackColor="Gray" Height="123px" 
              Width="328px">
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                  BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" 
                  CellPadding="3" Font-Overline="False" GridLines="None" Height="35px" 
...
<ul><li class="labeltopformflow"><asp:Label ID="managerdis" runat="server" Text="Manager > Discipline > Workforce Administration "></asp:Label>
        <asp:Label ID="labelposition" Font-Underline="true" ForeColor="Black" runat="server" Text="> Receive Application Details"></asp:Label>
        </li></ul> 
        </td>
        <td align="right">
