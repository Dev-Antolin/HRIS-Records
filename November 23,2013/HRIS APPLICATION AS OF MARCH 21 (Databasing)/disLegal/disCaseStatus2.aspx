<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/LegalMasterPage.master" AutoEventWireup="false" CodeFile="disCaseStatus2.aspx.vb" Inherits="DisDiscipline_disCaseApplication" title="Untitled Page" %>
...
<a><asp:Label ID="lblreceive" runat="server" Text="> Receive Case" Height="16px" Width="177px"></asp:Label></a><br />
...
<a><asp:Label ID="lblcode" runat="server" Text="> Code of Discipline" Height="16px" Width="177px"></asp:Label></a><br />
      ...
      <td style="height: 34px; width: 87px;"></td>
       <td style="height: 34px" align="justify">
           <table style="width: 100%; height: 125px;">
               ...
               <tr>
                   <td style="height: 81px; width: 192px">
                   </td>
                   <td style="height: 81px; width: 22px">
                   </td>
               </tr>
               <tr>
