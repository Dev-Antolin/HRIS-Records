<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/LegalMasterPage.master" AutoEventWireup="false" CodeFile="disReceiveCase2.aspx.vb" Inherits="DisDiscipline_disCaseApplication" title="Untitled Page" %>
...
<a  style="color:red; font-size:small;"><asp:Label ID="lblreceive" runat="server" Text="> Receive Case" Height="16px" Width="177px"></asp:Label></a><br />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width:100%;" align="right">
        ...
        <tr>
            <td style="width: 352px" align="right">
            ...
            <td style="width: 851px">
                ...
                <td style="width: 213px">
                    <asp:TextBox ID="TextBox12" runat="server" Width="193px" BackColor="#D4D0C8"></asp:TextBox></td>
            <td style="width: 244px">
                <asp:ImageButton ID="cmdbrowse" runat="server" Height="25px" 
                    ImageUrl="~/images/Buttons/browse.gif" Width="75px" />
            </td>
        </tr>
    </table>
    <table style="width:99%; margin-top:130px;">
    <tr>
    ...
    <td style="width: 76px; height: 61px;"></td>
    <td rowspan="3">
        <table style="width:84%;" align="right">
    ...
    <td style="height: 117px; width: 39px;"></td>
     ...
     <tr>
         <td style="height: 49px; width: 39px;">
         </td>
                 ...
                 <tr>
                     <td>
                         <asp:Label ID="Label1" runat="server" Font-Names="Arial" Font-Size="Small" 
                             ForeColor="Black" Text="Legal Asssessment"></asp:Label>
                     </td>
                 </tr>
                 <tr>
                     <td>
                         <asp:TextBox ID="TextBox11" runat="server" Font-Names="Arial" Font-Size="Small" 
                             Height="71px" TextMode="MultiLine" Width="351px"></asp:TextBox>
                     </td>
                 </tr>
             </table>
         </td>
        ...
        <tr>
            ...
            <td rowspan="2">
                <table style="width:100%; height: 90px;">
                    <tr>
                        <td>
                            <asp:Label ID="lbllegal" runat="server" Font-Names="Arial" Font-Size="Small" 
                                ForeColor="Black" Text="Comments"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:TextBox ID="TextBox17" runat="server" Font-Names="Arial" Font-Size="Small" 
                                Height="71px" TextMode="MultiLine" Width="351px"></asp:TextBox>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            ...
            <td align="justify" style="height: 34px">
                <table style="width: 100%; height: 127px;">
                    ...
                    <tr>
                        <td style="height: 96px; width: 198px">
                        </td>
                    ...
                    <tr>
                        <td align="right" style="width: 198px">
                            <asp:ImageButton ID="cmdpending" runat="server" 
                                ImageUrl="~/images/Buttons/Pending.gif" Height="25px" Width="75px" />
                        </td>
                        <td>
                            <asp:ImageButton ID="cmdendorse" runat="server" 
                                ImageUrl="~/images/Buttons/endorse.gif" Height="25px" Width="75px" />
                        </td>
                    </tr>
                </table>
            </td>
...
<ul><li class="labeltopformflow"><asp:Label ID="dislegal" runat="server" Text="HRMD > Discipline > Workforce Administration "></asp:Label>
        <asp:Label ID="labelposition" Font-Underline="true" ForeColor="Black" runat="server" Text="> Receive Case Details"></asp:Label>
        </li></ul> 
        </td>
        <td align="right">
