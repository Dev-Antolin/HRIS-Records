<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/HRMasterPage.master"
    AutoEventWireup="false" CodeFile="NewlyRegularized.aspx.vb" Inherits="recHRMDinfo_Profile_NewlyRegularized"
    Title="Newly Regularized" %>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 756px">
                    <asp:Panel ID="panelDisplay" runat="server" Height="396px" Width="752px">
        ...
        <tr>
            ...
            <td style="width: 569px">
                <asp:Label ID="lblheader" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Arial"
                    Font-Size="13px" ForeColor="DodgerBlue" Text="HRMD &gt; Records &gt; Profile &gt; Reports "> </asp:Label>
                <asp:Label ID="lblheader2" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Arial"
                    Font-Size="13px" Font-Underline="True" ForeColor="Black" Text="&gt; Newly Regularized"> </asp:Label>
            </td>
