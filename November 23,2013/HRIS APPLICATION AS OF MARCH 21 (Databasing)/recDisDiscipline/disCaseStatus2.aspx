<%@ Page Language="VB" MasterPageFile="~/MASTER_PAGES/MAIN_MASTER/HRIS/DisciplineMasterPage.master"
    AutoEventWireup="false" CodeFile="disCaseStatus2.aspx.vb" Inherits="DisDiscipline_disCaseApplication"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel runat="server" ID="pnlrecapplication2" Width="100%" Height="479px" ScrollBars="Vertical">
        <table style="width: 100%;" align="right">
            ...
            <tr>
                <td style="width: 102px">
                    <asp:Label ID="lblcaseno" runat="server" Font-Names="Arial" Font-Size="Small" ForeColor="Black"
            ...
            <tr>
                <td style="width: 102px">
                    <asp:Label ID="lblcasetitle" runat="server" Font-Names="Arial" Font-Size="Small"
                        ForeColor="Black" Text="Case Title"></asp:Label>
                </td>
                <td style="width: 184px">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="TextBox10" runat="server" Font-Names="Arial" Font-Size="Small" Height="71px"
                                    TextMode="MultiLine" Width="351px" BackColor="#D4D0C8"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
                <td style="height: 117px;" align="center" colspan="2">
                    <asp:Panel ID="Panel1" runat="server" BackColor="Gray" Height="97px" Width="328px">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                            ...
                            <Columns>
                                <asp:BoundField HeaderStyle-Height="25px" HeaderText="Date" ItemStyle-Height="20px"
                                    ...
                                    <HeaderStyle BackColor="#999999" BorderColor="Black" Height="15px" VerticalAlign="Middle" />
            ...
            <tr>
                ...
                <td rowspan="2">
                    <table style="width: 100%; height: 90px;">
                        <tr>
                            <td>
                                <asp:Label ID="lbllegal" runat="server" Font-Names="Arial" Font-Size="Small" ForeColor="Black"
                                    Text="Legal Assessment"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:TextBox ID="TextBox16" runat="server" BackColor="#D4D0C8" Font-Names="Arial"
                                    Font-Size="Small" Height="71px" TextMode="MultiLine" Width="351px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="TextBox17" runat="server" BackColor="#D4D0C8" Font-Names="Arial"
                                    Font-Size="Small" Height="71px" TextMode="MultiLine" Width="351px"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
